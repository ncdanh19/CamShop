...
namespace CamShop.Areas.Admin.Controllers
{
    public class ThuongHieuController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "thuongHieuID,tenThuongHieu,metaTitle")] ThuongHieu thuongHieu)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "thuongHieuID,tenThuongHieu,metaTitle")] ThuongHieu thuongHieu)
        {
            if (ModelState.IsValid)
            {
