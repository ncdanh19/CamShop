...
namespace CamShop.Controllers
{
    public class ThanhToanController : Controller
    {
        ...
        public ActionResult PaymentWithPaypal(string hoTen, string diaChi, string eMail, string soDienThoai, string donViGH, string duong, string phuong, string quan, string thanhPho)
        {
            //try
            //{
            if ((UserLogin)Session[Common.CommonConstants.USER_SESSION] == null)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (session != null)
                        {
                            ...
                            hoaDon.maKhach = ((UserLogin)Session[Common.CommonConstants.USER_SESSION]).UserID;
                            ...
                            foreach (var item in gioHang)
                            {
                                ...
                                chiTiet.thanhTien = item.SoLuong * item.SanPham.donGia;
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                khachHang.soDienThoai = _soDienThoai.Trim();
                                khachHang.passWord = Encrytor.MD5Hash("123456");
                                khachHang.confirmPassword = Encrytor.MD5Hash("123456");
                            ...
                            foreach (var item in gioHang)
                            {
                                ...
                                chitietHD.thanhTien = item.SoLuong * item.SanPham.donGia;
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (session != null)
                    {
                        //Create Order for User
                        var hoaDon = new HoaDon();
                        hoaDon.maKhach = ((UserLogin)Session[CommonConstants.USER_SESSION]).UserID;
                        hoaDon.loaiHoaDon = "Mua";
                        hoaDon.trangThai = true;
                        hoaDon.ngayMuaHang = DateTime.Now;
